...
public class MemberController {
    ...
    @Operation(summary = "회원 조회 요청", description = "멤버십을 통해 회원 정보를 조회합니다.", tags = {
        "MemberController"})
    @GetMapping("/membership")
    public ResponseEntity<List<MemberResponse>> findByMemberShip(
    ...
    @Operation(summary = "트레이너 등록 요청", description = "회원에게 트레이너가 지정됩니다.", tags = {
        "MemberController"})
